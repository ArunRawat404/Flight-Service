...
async function createAirplane(data) {
    try {
        ...
        if (error.name == "SequelizeValidationError") {
            ...
            // Send client-related status code for SequelizeValidationError
...
async function destroyAirplane(id) {
    try {
        ...
        throw new AppError("Cannot delete data of the airplane you requested", StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
